...
CEREMONIES_CONFIG = {
    "carthage": {
        "slug": "carthage-film-festival",
        "name": "Carthage Film Festival",
        "csv": "carthage_film_festival_awards/carthage_awards.csv",
        "start_year": 1966,
        "country": "Tunisia",
        "language": "Arabic"
    },
    "el-gouna": {
        "slug": "el-gouna-film-festival",
        "name": "El Gouna Film Festival",
        "csv": "el_gouna_film_festival_awards/el_gouna_awards.csv",
        "start_year": 2017,
        "country": "Egypt",
        "language": "Arabic"
    },
    "fespaco": {
        ...
        "csv": "fespaco_etalon_dor/fespaco_awards.csv",
        "start_year": 1969,
    ...
    "zanzibar": {
        ...
        "csv": "zanzibar_iff_awards/zanzibar_iff_awards.csv",
        "start_year": 1997,
        "country": "Tanzania",
        "language": "Swahili"
    },
    "aca": {
        "slug": "african-cinematography-awards",
        "name": "African Cinematography Awards",
        "csv": "african_cinematography_awards/african_cinematography_awards.csv",
        "start_year": 2010,
        "country": "Various",
        "language": "English"
    }
...
def ingest_ceremony(conn, config):
    ...
    panafrican_dir = os.path.dirname(os.path.abspath(__file__))
    csv_path = os.path.join(panafrican_dir, csv_rel)
...
def main():
    ...
    try:
        ...
        print("\n[+] All Pan-African awards ingested successfully into MySQL!")
