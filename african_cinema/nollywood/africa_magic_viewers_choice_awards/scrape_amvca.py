...
TOR_SOCKS_PORT = 9050
HEADERS = {
    "User-Agent": "MultiThreadAMVCAScraper/1.0 (educational data science project; contact: student_scraper@example.com)"
}

AMVCA_CEREMONIES = [
    {"year": 2013, "wiki": "2013_Africa_Magic_Viewers%27_Choice_Awards", "name": "1st Africa Magic Viewers' Choice Awards"},
    {"year": 2014, "wiki": "2014_Africa_Magic_Viewers%27_Choice_Awards", "name": "2nd Africa Magic Viewers' Choice Awards"},
    {"year": 2015, "wiki": "2015_Africa_Magic_Viewers%27_Choice_Awards", "name": "3rd Africa Magic Viewers' Choice Awards"},
    {"year": 2016, "wiki": "2016_Africa_Magic_Viewers%27_Choice_Awards", "name": "4th Africa Magic Viewers' Choice Awards"},
    {"year": 2017, "wiki": "2017_Africa_Magic_Viewers%27_Choice_Awards", "name": "5th Africa Magic Viewers' Choice Awards"},
    {"year": 2018, "wiki": "2018_Africa_Magic_Viewers%27_Choice_Awards", "name": "6th Africa Magic Viewers' Choice Awards"},
    {"year": 2020, "wiki": "2020_Africa_Magic_Viewers%27_Choice_Awards", "name": "7th Africa Magic Viewers' Choice Awards"},
    {"year": 2022, "wiki": "2022_Africa_Magic_Viewers%27_Choice_Awards", "name": "8th Africa Magic Viewers' Choice Awards"},
    {"year": 2023, "wiki": "2023_Africa_Magic_Viewers%27_Choice_Awards", "name": "9th Africa Magic Viewers' Choice Awards"},
    {"year": 2024, "wiki": "2024_Africa_Magic_Viewers%27_Choice_Awards", "name": "10th Africa Magic Viewers' Choice Awards"},
    {"year": 2025, "wiki": "2025_Africa_Magic_Viewers%27_Choice_Awards", "name": "11th Africa Magic Viewers' Choice Awards"},
    {"year": 2026, "wiki": "2026_Africa_Magic_Viewers%27_Choice_Awards", "name": "12th Africa Magic Viewers' Choice Awards"}
]
...
def main():
    combined_results = []
    print("[*] Starting AMVCA scraping run...")
    
    with ThreadPoolExecutor(max_workers=4) as executor:
        futures = []
        for index, c_info in enumerate(AMVCA_CEREMONIES):
    ...
    if not df.empty:
        ...
        output_file_path = os.path.join(output_dir, "amvca_awards.csv")
        df.to_csv(output_file_path, index=False, quoting=csv.QUOTE_MINIMAL)
        print(f"[+] AMVCA data saved to: {output_file_path}")
        print(f"Total Unique Nominations: {len(df)}")
    else:
        print("[-] ERROR: No AMVCA records scraped.")
