...
CEREMONIES_CONFIG = {
    "amaa": {
        ...
        "csv": "africa_movie_academy_awards/amaa_awards.csv",
        "start_year": 2004,
        "country": "Nigeria",
        "language": "English"
    },
    "amvca": {
        ...
        "csv": "africa_magic_viewers_choice_awards/amvca_awards.csv",
        "start_year": 2012,
        "country": "Nigeria",
        "language": "English"
    },
    "best-of-nollywood-awards": {
        "slug": "best-of-nollywood-awards",
        "name": "Best of Nollywood Awards",
        "csv": "best_of_nollywood_awards/bon_awards.csv",
        "start_year": 2008,
        "country": "Nigeria",
        "language": "English"
    },
    "nea": {
        ...
        "csv": "nigeria_entertainment_awards/nea_awards.csv",
        "start_year": 2005,
        "country": "Nigeria",
        "language": "English"
    },
    "afriff": {
        ...
        "csv": "africa_international_film_festival/afriff_awards.csv",
        "start_year": 2009,
        "country": "Nigeria",
        "language": "English"
    },
    "city-people-movie-awards": {
        "slug": "city-people-movie-awards",
        "name": "City People Movie Awards",
        "csv": "city_people_movie_awards/city_people_awards.csv",
        "start_year": 2008,
        "country": "Nigeria",
        "language": "English"
    }
...
# Maps category keywords → (department, is_craft)
DEPT_KEYWORDS = [
    ("director",          "Directing",       False),
    ("screenplay",        "Writing",         False),
    ("writer",            "Writing",         False),
    ("actor",             "Acting",          False),
    ("actress",           "Acting",          False),
    ("lead",              "Acting",          False),
    ("supporting",        "Acting",          False),
    ("promising",         "Acting",          False),
    ("cinematograph",     "Cinematography",  True),
    ...
    ("overall movie",     "Film",            False),
    ("best movie",        "Film",            False),
    ("best film",         "Film",            False),
    ("indigenous",        "Film",            False),
]
...
def ingest_ceremony(conn, config):
    ...
    nollywood_dir = os.path.dirname(os.path.abspath(__file__))
    csv_path = os.path.join(nollywood_dir, csv_rel)
    ...
    try:
        ...
        # Clear stale data (nominations cascade-delete via FK)
        ...
        conn.commit()
        print(f"    [+] Cleared old editions/categories for '{name}'.")
        ...
        for _, row in df.iterrows():
            ...
            if row_res is None:
                print(f"ERROR: Could not find film with slug '{film_slug}' (Title: '{film_title}', Year: {year})")
                sys.exit(1)
            film_id_map[film_key] = row_res[0]
        conn.commit()
        ...
        conn.commit()
        print(f"    [+] Inserted {len(nomination_rows)} nominations ({skipped} skipped).")
...
def main():
    ...
    try:
        ...
        print("\n[+] All Nollywood awards ingested successfully into MySQL!")
