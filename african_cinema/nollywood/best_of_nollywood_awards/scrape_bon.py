...
TOR_SOCKS_PORT = 9050
HEADERS = {
    "User-Agent": "MultiThreadBONScraper/1.0 (educational data science project; contact: student_scraper@example.com)"
}

BON_CEREMONIES = [
    {"year": 2009, "wiki": "2009_Best_of_Nollywood_Awards", "name": "1st Best of Nollywood Awards"},
    {"year": 2010, "wiki": "2010_Best_of_Nollywood_Awards", "name": "2nd Best of Nollywood Awards"},
    {"year": 2011, "wiki": "2011_Best_of_Nollywood_Awards", "name": "3rd Best of Nollywood Awards"},
    {"year": 2012, "wiki": "2012_Best_of_Nollywood_Awards", "name": "4th Best of Nollywood Awards"},
    {"year": 2013, "wiki": "2013_Best_of_Nollywood_Awards", "name": "5th Best of Nollywood Awards"},
    {"year": 2014, "wiki": "2014_Best_of_Nollywood_Awards", "name": "6th Best of Nollywood Awards"},
    {"year": 2015, "wiki": "2015_Best_of_Nollywood_Awards", "name": "7th Best of Nollywood Awards"},
    {"year": 2016, "wiki": "2016_Best_of_Nollywood_Awards", "name": "8th Best of Nollywood Awards"},
    {"year": 2017, "wiki": "2017_Best_of_Nollywood_Awards", "name": "9th Best of Nollywood Awards"},
    {"year": 2018, "wiki": "2018_Best_of_Nollywood_Awards", "name": "10th Best of Nollywood Awards"},
    {"year": 2019, "wiki": "2019_Best_of_Nollywood_Awards", "name": "11th Best of Nollywood Awards"},
    {"year": 2020, "wiki": "2020_Best_of_Nollywood_Awards", "name": "12th Best of Nollywood Awards"},
    {"year": 2021, "wiki": "2021_Best_of_Nollywood_Awards", "name": "13th Best of Nollywood Awards"},
    {"year": 2022, "wiki": "2022_Best_of_Nollywood_Awards", "name": "14th Best of Nollywood Awards"}
]
...
def main():
    combined_results = []
    print("[*] Starting BON scraping run...")
    
    with ThreadPoolExecutor(max_workers=4) as executor:
        futures = []
        for index, c_info in enumerate(BON_CEREMONIES):
    ...
    if not df.empty:
        ...
        output_file_path = os.path.join(output_dir, "bon_awards.csv")
        df.to_csv(output_file_path, index=False, quoting=csv.QUOTE_MINIMAL)
        print(f"[+] BON data saved to: {output_file_path}")
        print(f"Total Unique Nominations: {len(df)}")
    else:
        print("[-] ERROR: No BON records scraped.")
