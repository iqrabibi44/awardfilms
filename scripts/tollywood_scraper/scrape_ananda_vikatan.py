"""
scrape_ananda_vikatan.py
Scrapes Ananda Vikatan Cinema Awards. Like Sun Kudumbam Viridhugal, this award's
Wikipedia/structured-web footprint is thin. Built with the same fail-loudly-into-gaps
pattern as scrape_sun_kudumbam.py.
"""
...
AWARD_SHOW = "Ananda Vikatan Cinema Awards"
LANGUAGE = "Tamil"

MAIN_PAGE = "Ananda Vikatan Cinema Awards"
...
def scrape():
    ...
    try:
        ...
        log.warning("No usable Wikipedia page for Ananda Vikatan Cinema Awards: %s", e)
        gaps.append([AWARD_SHOW, "", "ALL",
                     f"main page fetch failed: {e} -- source manually from Vikatan.com archives"])
...
if __name__ == "__main__":
    rows, gaps = scrape()
    write_csv(rows, "output/ananda_vikatan_cinema_awards.csv")
    write_gaps(gaps, "output/ananda_vikatan_cinema_awards_gaps.csv")
