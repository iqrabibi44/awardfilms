...
CEREMONIES_CONFIG = {
    "lola": {
        "slug": "german-film-awards",
        "name": "German Film Awards Lola",
        "csv": "german_film_awards/lola_awards.csv",
        "start_year": 1951,
        "country": "Germany",
        "language": "German"
    },
    "bavarian": {
        "slug": "bavarian-film-awards",
        "name": "Bavarian Film Awards",
        "csv": "bavarian_film_awards/bavarian_awards.csv",
        "start_year": 1979,
        "country": "Germany",
        "language": "German"
    },
    "berlin": {
        "slug": "berlin-iff",
        "name": "Berlin IFF Golden Bear",
        "csv": "berlin_iff/berlin_awards.csv",
        "start_year": 1951,
        "country": "Germany",
        "language": "German"
    }
...
def ingest_ceremony(conn, config):
    ...
    german_dir = os.path.dirname(os.path.abspath(__file__))
    csv_path = os.path.join(german_dir, csv_rel)
...
def main():
    ...
    try:
        ...
        print("\n[+] All German cinema awards ingested successfully into MySQL!")
